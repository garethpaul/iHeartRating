...
- Rating controls should not crash on empty image arrays, single-rating views, zero-sized images, invalid `maxRating`, inconsistent rating bounds, out-of-range ratings, or unexpected image assets.
