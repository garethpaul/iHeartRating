#
#  Be sure to run `pod spec lint iHeartRating.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  #
  s.source       = { :git => "https://github.com/garethpaul/iHeartRating.git", :branch => "master", :tag => "0.0.1" }
